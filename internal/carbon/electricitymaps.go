...
// electricityMapsResponse matches the carbon-intensity/latest response.
...
// ElectricityMapsClient fetches real-time carbon intensity from ElectricityMaps (global, requires API key).
